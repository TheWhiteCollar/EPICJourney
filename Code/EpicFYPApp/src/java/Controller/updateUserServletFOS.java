...
@WebServlet(name = "updateUserServletFOS", urlPatterns = {"/updateUserServletFOS"})
public class updateUserServletFOS extends HttpServlet {
...
//        String userSchool = request.getParameter("school");
        ...
        //if (!userFirstName.equals("") && !userLastName.equals("") && !userCitizenship.equals("") && !userHighestEducation.equals("") && !userSchool.equals("") && !userFieldOfStudy.equals("")) {
            ...
            boolean insertedUser  = UserDAO.updateUserFieldOfStudy(userEmail, userFieldOfStudy);
