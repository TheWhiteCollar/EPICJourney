...
@WebServlet(name = "updateUserServletYob", urlPatterns = {"/updateUserServletYob"})
public class updateUserServletYob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int yearOfBirth = Integer.parseInt(yob);
            ...
            boolean insertedUser  = UserDAO.updateUserYob(userEmail, yearOfBirth);
