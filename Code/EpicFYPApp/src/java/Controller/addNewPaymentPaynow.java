    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!chequeNumber.equals("")) {
            ...
            if (type.equals("deposit")) {
                ...
                inserted = PaymentDAO.addPayment(tripStudentID, "PayNow", chequeNumber, amountI);
                paymentID = PaymentDAO.getPaymentID(tripStudentID, "PayNow", chequeNumber, amountI);
                ...
                try {
                    ...
                    message.setSubject("EPIC PTE LTD - Deposit successfully received via paynow");
